...
@section('content')
    ...
    <div class="bg-white border border-zinc-200 shadow-sm overflow-hidden">
        <div class="border-b border-zinc-200 px-8 py-6 flex justify-between items-center bg-zinc-50/50">
            <div>
                <h3 class="font-serif text-2xl text-zinc-900 tracking-tight">Tambah Anggota Baru</h3>
                <p class="text-xs text-zinc-500 mt-1">Isi data anggota tim yang akan tampil di website.</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-10 mb-6">
                ...
                <div class="md:col-span-8 space-y-8">
                    ...
                    <div class="bg-zinc-50 border border-zinc-200 p-5 flex items-start gap-4">
                        ...
                        <p class="text-xs text-zinc-600 leading-relaxed">Data ini akan ditampilkan di halaman "Cerita Kami" pada website.</p>
                    </div>
                </div>
