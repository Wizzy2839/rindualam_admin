...
@section('content')
    <header class="relative pt-40 pb-20 bg-white text-center">
        <div class="container mx-auto px-6 reveal-up">
            ...
            <h1 class="font-serif text-4xl md:text-5xl lg:text-7xl font-normal tracking-tight mb-6">Our Locations</h1>
        ...
        <div class="container mx-auto px-6">
            <div class="flex flex-col lg:flex-row gap-16 items-start">
                <div class="lg:w-1/3 reveal-up">
                    ...
                    <h2 class="font-serif text-3xl md:text-4xl mb-6">Ngebel Lake</h2>
                ...
                <div class="lg:w-2/3 w-full h-[300px] md:h-[400px] bg-gray-100 reveal-up delay-100 relative group overflow-hidden">
                    <iframe 
        ...
        <div class="container mx-auto px-6">
            <div class="flex flex-col lg:flex-row-reverse gap-16 items-start">
                <div class="lg:w-1/3 reveal-up">
                    ...
                    <h2 class="font-serif text-3xl md:text-4xl mb-6">City Hub</h2>
                    <p class="text-gray-600 text-sm leading-7 mb-8 font-light">
                ...
                <div class="lg:w-2/3 w-full h-[300px] md:h-[400px] bg-white reveal-up delay-100 relative group overflow-hidden">
                    <iframe 
    ...
    <section class="py-28 bg-black text-white text-center">
        <div class="container mx-auto px-6 max-w-2xl reveal-up">
            <h2 class="font-serif text-3xl md:text-5xl mb-6 font-normal">Have a Question?</h2>
