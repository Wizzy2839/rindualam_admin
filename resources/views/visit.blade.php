...
@section('content')
        ...
        <div class="container mx-auto px-6">
            <div class="flex flex-col lg:flex-row gap-16 items-start">
                <div class="lg:w-1/3 reveal-up">
                    ...
                    <div class="space-y-4 text-sm mb-10">
                        <div class="flex gap-4">
                            ...
                            <p class="font-light">{{ !empty($setting->address_central) ? $setting->address_central : 'Jl. Telaga Ngebel, Ponorogo, Jawa Timur' }}</p>
                        </div>
                        <div class="flex gap-4">
                            <i class="ph ph-map-pin text-xl"></i>
                            <p class="font-light">Everyday: {{ !empty($setting->open_hours) ? $setting->open_hours : '08:00 AM — 11:00 PM' }}</p>
                        </div>
                    </div>
                ...
                <div class="lg:w-2/3 w-full h-[400px] bg-gray-100 reveal-up delay-100 relative group overflow-hidden">
                    <iframe 
                        src="{{ !empty($setting->map_url_central) ? $setting->map_url_central : 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3952.5414840810375!2d111.65487731477833!3d-7.838275994352219!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e79a0b0b8c6dfbb%3A0x6b876251b14a2c9!2sTelaga%20Ngebel!5e0!3m2!1sen!2sid!4v1620000000000!5m2!1sen!2sid' }}" 
                        class="w-full h-full md:grayscale md:invert md:opacity-90 opacity-100 md:group-hover:opacity-100 transition-opacity duration-500" 
            ...
            <div class="flex flex-col lg:flex-row-reverse gap-16 items-start">
                <div class="lg:w-1/3 reveal-up">
                    ...
                    <div class="space-y-4 text-sm mb-10">
                        <div class="flex gap-4">
                            <i class="ph ph-map-pin text-xl"></i>
                            <p class="font-light">{{ !empty($setting->address_branch) ? $setting->address_branch : 'Jl. Sudirman, Ponorogo, Jawa Timur' }}</p>
                        </div>
                        <div class="flex gap-4">
    ...
    <section class="py-28 bg-black text-white text-center">
        <div class="container mx-auto px-6 max-w-2xl reveal-up">
            <h2 class="font-serif text-4xl md:text-5xl mb-6 font-normal">{{ !empty($setting->visit_cta_title) ? $setting->visit_cta_title : 'Have a Question?' }}</h2>
            <p class="text-gray-400 font-light mb-10 text-sm leading-7">
                {{ !empty($setting->visit_cta_text) ? $setting->visit_cta_text : 'Kami siap menyambut Anda. Untuk reservasi grup besar, event, atau kerjasama, jangan ragu untuk menghubungi kami.' }}
            </p>
